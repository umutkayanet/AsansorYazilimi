<%@ Page Title="" Language="C#" MasterPageFile="~/Merkez_Nokta.master" AutoEventWireup="true" CodeFile="Ariza_ParcaEkle.aspx.cs" Inherits="Modul_Ariza_ParcaEkle" EnableEventValidation="false" %>
            ...
            <div class="page-header">
                ...
                <div class="breadcrumb-line">
                     <ul class="breadcrumb">
                        ...
                        <li><a href="/Servis/Ariza-Listesi/<%=RouteData.Values["id"].ToString()%>">Arıza Listesi</a></li>
                                    ...
                                    <asp:Repeater ID="rep1" runat="server" EnableViewState="True" OnItemCommand="rep1_ItemCommand" OnItemCreated="rep1_ItemCreated" ClientIDMode="AutoID">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%#Eval("CariAsansorArizaSec_ParcaAdet") %></td>
                                                <td><%# Convert.ToDateTime(Eval("CariAsansorArizaSec_Tarih")).ToString("dd.MM.yyyy") %></td>
                                                <td style="text-align: center">
                                                    <asp:LinkButton ID="sil" runat="server" CssClass="btn btn-default btn-icon tip" data-original-title="Sil" CommandName="sil" CommandArgument='<%# Eval("CariAsansorArizaSec_Id") %>' OnClientClick="javascript:if(!confirm('Kaydı silmek istediğinizden eminmisiniz.'))return false;"><i class="icon-remove3"></i></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
