<%@ Page Title="" Language="C#" MasterPageFile="~/Merkez_Nokta.master" AutoEventWireup="true" CodeFile="Ariza_Ekle.aspx.cs" Inherits="Modul_Ariza_Ekle" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
            ...
            <div class="page-header">
                <div class="page-title">
                    <h3>Arıza Listesi<small>Lütfen aşağıdaki alanları eksiksiz doldurunuz.</small></h3>
                </div>
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Arıza Listesi</li>
                    </ul>
                </div>
                <!-- Son -->
            ...
            <div class="tablo_uzeri_buton" runat="server" id="buttonlar_panel" visible="false">
                <a href="/Servis/Ariza-Listesi/<%=RouteData.Values["id"]%>" class="btn btn-success"><i class="icon-plus-circle"></i>Yeni Arıza Ekle</a>
            </div>
                    ...
                    <div class="col-md-7">
                                                    ...
                                                    <div class="form-group" style="margin: 0px 0 -18px 0">
                                                        <div class="col-sm-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <asp:DropDownList ID="Durumu_arama" runat="server" CssClass="select-search4" TabIndex="2" AppendDataBoundItems="True" Width="250px"  DataSourceID="ariza_durumu_sql" DataValueField="Durumu_Id" DataTextField="Durumu_Aciklama">
                                                                ...
                                                                <div class="row">
                                                                <div class="col-sm-6">
                                                                    <asp:TextBox ID="tarih_arama" runat="server" CssClass="form-control" MaxLength="11" data-mask="99/99/9999" PlaceHolder="Arıza Tarihi"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-6">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h6 class="panel-title"><i class="icon-tools"></i>Arıza Listesi</h6>
                                <!-- Menü Buton -->
                            ...
                            <div class="datatablee">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th style="width: 20%;">Asansör Tanımı</th>
                                            <th>Açıklama</th>
                                            <th style="width: 13%;">Toplam Parça</th>
                                            <th style="width: 13%;">Arıza Durumu</th>
                                            <th style="width: 12%;">Arıza Tarihi</th>
                                    ...
                                    <asp:Repeater ID="rep1" runat="server" EnableViewState="True" OnItemCommand="rep1_ItemCommand" OnItemDataBound="rep1_ItemDataBound" ClientIDMode="AutoID">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%#Eval("Arıza Açıklaması") %></td>
                                                <td><%#Eval("Toplam Parça") %></td>
                                                <td><%#Eval("Durum Style") %></td>
                                                <td><%#Convert.ToDateTime(Eval("Arıza Tarihi")).ToString("dd.MM.yyyy") %></td>
                                                <td style="text-align: center">                                                    
                                                    <a href="/Servis/Ariza-Listesi/<%=RouteData.Values["id"]%>/<%#Eval("CariAsansorAriza_Id") %>" title="Düzenle" class="btn btn-default btn-icon tip" data-original-title="Düzenle">
                                                        <i class="icon-pencil3"></i>
                                                    </a>

                                                    <a href="/Servis/Ariza-ParcaEkle/<%=RouteData.Values["id"]%>/<%#Eval("CariAsansorAriza_Id") %>" title="Parça Ekle" class="btn btn-default btn-icon tip" data-original-title="Parça Ekle">
                                                        <i class="icon-cog4"></i>
                                                    </a>

                                                    <asp:LinkButton ID="sil" runat="server" CssClass="btn btn-default btn-icon tip" data-original-title="Sil" CommandName="sil" CommandArgument='<%# Eval("CariAsansorAriza_Id") %>' OnClientClick="javascript:if(!confirm('Kaydı silmek istediğinizden eminmisiniz.'))return false;"><i class="icon-remove3"></i></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                    ...
                    <div class="col-md-5">
                        <div class="panel panel-default">
                            <div class="panel-heading" runat="server" id="guncelle_div">
                                <h6 class="panel-title"><i class="icon-tools"></i>
                                    <asp:Label ID="yeni_kayit_buton" runat="server" Text="Yeni Arıza Ekle"></asp:Label>
                                </h6>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Görevli Personel</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Arıza Açıklaması</label>
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="t9" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Arıza Tarihi</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Arıza Notu</label>
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="t4" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:RadioButtonList ID="durumu" CssClass="renk_radio" runat="server" DataSourceID="ariza_durumu_sql" DataTextField="Durumu_Style" DataValueField="Durumu_Id" RepeatDirection="Horizontal"></asp:RadioButtonList>
                                        <asp:SqlDataSource ID="ariza_durumu_sql" runat="server" ConnectionString="<%$ ConnectionStrings:connect %>" ProviderName="<%$ ConnectionStrings:connect.ProviderName %>" SelectCommand="SELECT * FROM [tblDurumu] where Durumu_Kategori='Ariza' order by Durumu_Sira"></asp:SqlDataSource>
                                    </div>
                                </div>
