...
================================================== */
	...
	oTable = $('.datatable table').dataTable({
		...
		"oLanguage": {
			...
			"sLengthMenu": "<span>Kayıt Sayısı:</span> _MENU_",
    ...
    oTable = $('.servishatirlatma table').dataTable({
        "aaSorting": [],
        "bFilter ": true,
        "bJQueryUI": false,
        "bPaginate":true,
	...
	oTable = $('.datatable-pager table').dataTable({
		...
		"oLanguage": {
            "sSearch": "<span>Hızlı Filtreleme:</span> _INPUT_",
			"sLengthMenu": "<span>Kayıt Sayısı:</span> _MENU_",
			"oPaginate": { "sNext": "İleri →", "sPrevious": "← Geri" }
		}
    });
	...
	$('.dataTables_filter input[type=text]').attr('placeholder','Anahtar Kelime...');
